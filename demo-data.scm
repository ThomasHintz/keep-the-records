(define (setup-demo u-name)
  ...
  (let ((c-name (as-db-unique (lambda (c-n) (club-name c-n)) "demo-club" 0)))
    ...
    (map (lambda (data)
         ...
         '(("Jamie Farmer" "Pre-k" "2/25/2006" "Cubbies" "" "Ray Farmer"
            (("2010/10/06" (p b h)) ("2010/10/13" (p b h u)) ("2010/10/20" (p b h u)) ("2010/10/27" (p b h u))))
           ("John Farmer" "1" "3/4/2004" "Sparks" "" "Ray Farmer"
            (("2010/10/06" (p b h)) ("2010/10/13" (p b h u)) ("2010/10/20" (p h u)) ("2010/10/27" (p b h u))))
           ("Roy Johnson" "3" "4/2/2002" "TnT" "Wheat" "Dew Mountain"
            (("2010/10/06" (p h)) ("2010/10/13" (p h)) ("2010/10/27" (p))))
           ("Sara Snower" "4" "3/14/2001" "TnT" "" "Randy Acorn"
            (("2010/10/06" (p b h u)) ("2010/10/13" (p b h u)) ("2010/10/20" (p b h u f)) ("2010/10/27" (p b h u))))
           ("Sally Snower" "2" "1/1/2003" "Sparks" "Milk" "Randy Acorn"
            (("2010/10/06" (p b h u)) ("2010/10/13" (p b h u)) ("2010/10/20" (p b h u)) ("2010/10/27" (p b h u))))
