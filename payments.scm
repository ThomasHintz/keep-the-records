...
(define-page "/add-account"
  (lambda ()
    (add-customer ($ 'stripeToken) email: ($ 'email) plan: ($ 'plan))
    "good")
  method: 'POST
  no-session: #t)
...
(define-awana-app-page (regexp "/sign-up/(free|basic|plus|premier|ultimate)")
  (lambda (path)
    (add-javascript "Stripe.setPublishableKey('CG3MRYjCWmMz9pgZREFBOclg677UqOLS');")
    (let ((plan (second (string-split path "/"))))
    (++ (<div> class: "grid_12"
	...
	(<div> class: "grid_6 column-body"
	       (<div> class: "padding"
		      ...
		      (<form> action: "/add-account" method: "POST" id: "payment-form"
			      (<input> type: "hidden" name: "plan" value: (second (string-split path "/"))) (<br>)
			      (<span> class: "form-context" "Full Name") (<br>)
			      (<input> type: "text" size: "20" class: "card-name text" value: "Joe Monkey") (<br>)
			      (<span> class: "form-context" "Email") (<br>)
			      (<input> type: "text" size: "20" class: "email text" name: "email" value: "eat@good.com") (<br>)
			      (<span> class: "form-context" "Credit Card Number") (<br>)
			      (<input> type: "text" size: "20" autocomplete: "off" class: "card-number text" value: "4242424242424242") (<br>)
			      (<span> class: "form-context" "Credit Card CVC")
			      (<br>)
			      (<input> type: "text" style: "width: 80px;" autocomplete: "off" class: "card-cvc text" value: "123")
			      (<span> class: "form-context" "3 or 4 digits on back of card")
			      (<br>)
			      (<span> class: "form-context" "Credit Card Expiration (MM/YYYY)") (<br>)
			      (<input> type: "text" style: "width: 80px;" class: "card-expiry-month text" value: "12")
			      (<span> class: "form-context" "/")
			      (<input> type: "text" style: "width: 169px;" class: "card-expiry-year text" value: "2013") (<br>)
